...
def get_default(setting_str: str, default=None):
    if setting_str in DEFAULTS:
        return DEFAULTS[setting_str]
...
# TODO: Syndra-specific defaults preserved from original config
# These were in syndra's original data.py and may be useful:
...
DEFAULT_TERMINAL = _get_config_var("terminal_command")
