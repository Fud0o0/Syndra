...
try:
    ...
    _BT_AVAILABLE = False
    logger.warning("gnome-bluetooth-3 non disponible — Bluetooth désactivé. Installez gnome-bluetooth-3.")
...
if _BT_AVAILABLE:
    class BluetoothDeviceSlot(CenterBox):
        ...
        def on_changed(self, *_):
            ...
            if self.device.connecting:
                self.connect_button.set_label("Connecting..." if not self.device.connecting else "...")
            else:
    ...
    class BluetoothConnections(Box):
        def __init__(self, **kwargs):
            ...
            self.buttons = self._widgets.buttons.bluetooth_button
