...
try:
    ...
    logger.warning("Gray non disponible — system tray désactivé. Installez python-gray (AUR) pour l'activer.")
...
class _DummySystemTray(Box):
    """Placeholder quand Gray n'est pas installé."""
    def __init__(self, **kwargs):
        super().__init__(name="systray", **kwargs)
